...
[assembly: MelonInfo(typeof(Siesta.Core), "Siesta", DooDesch.ModVersion.Current, "DooDesch", "https://github.com/DooDesch-Mods/ScheduleOne-Siesta")]
...
#if DEBUG
            Log.Msg("Siesta v1.2.2 (DEBUG) - NPC LOD active. Controls + live counters are in the Snitch panel \"Siesta LOD\".");
#else
            Log.Msg("Siesta v1.2.2 - NPC LOD active.");
#endif
        }
